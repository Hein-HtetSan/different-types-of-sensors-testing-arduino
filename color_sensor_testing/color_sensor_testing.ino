...
#define S0     8   // Please notice the Pin's define
#define S1     9  //Combination of S0 and S1 decision output signal frequency scaling factor
#define S2     10  //The combination of S2 and S3 decided to let the red, green, blue, what kind of light through a filter
#define S3     11  
#define OUT    12  
